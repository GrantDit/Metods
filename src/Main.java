...
public class Main {
    ...
    public static void printApplicationVersionInstallMessageResualt(int clientOS, boolean OldDevice) {
        if (OldDevice) {
            System.out.println("пожалуйста установите " + getClientOS(clientOS) + " легкую версию ");
        } else
            System.out.println("пожалуйста установите " + getClientOS(clientOS) + " обычную версию ");
    }
